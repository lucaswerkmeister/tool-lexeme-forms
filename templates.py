...
def match_template_to_lexeme_data(template, lexeme_data):
    ...
    properties_exclusive_for_template = properties_exclusive['test' if 'test' in template else 'www']
    for property_id in template.get('statements', {}):
        property_exclusive = properties_exclusive_for_template[property_id]
        for template_statement in template['statements'][property_id]:
            found_matching_statement = False
            for lexeme_statement in lexeme_data.get('claims', {}).get(property_id, []):
                ...
                if lexeme_statement['mainsnak']['snaktype'] == 'value':
                    ...
                    statement_matches = template_statement_value_id == lexeme_statement_value_id
                else:
                    statement_matches = False
