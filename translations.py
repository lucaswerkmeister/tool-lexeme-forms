translations = {
    ...
    'ml': {
        ...
        'duplicates_warning': 'താഴെ കൊടുത്തിരിക്കുന്ന ലെക്സീമുകൾക്ക് നിങ്ങൾ സൃഷ്ടിക്കാൻ ശ്രമിക്കുന്ന അതേ ലെമ്മയും ഭാഷാ കോഡും ഉണ്ട്:',
        ...
        'advanced_lexeme_id': 'പുതിയൊരെണ്ണം സൃഷ്ടിക്കുന്നതിനുപകരം നിലവിലുള്ള ഒരു ലെക്സീമിലേക്ക് ഫോമുകൾ ചേർക്കാൻ നിങ്ങൾക്ക് ഒരു ലെക്സീം ഐഡന്റിഫയർ നൽകാം. ലെക്സീമിൽ ഇതിനകം നിലവിലുള്ള ഏതെങ്കിലും ഫോമുകൾ ശൂന്യമായി വിടുക, അല്ലാത്തപക്ഷം അവ തനിപ്പകർപ്പാകും!',
        'advanced_partial_forms': 'നിങ്ങൾ ചില ഫോമുകൾ ശൂന്യമാക്കിയിടുകയാണെങ്കിൽ, അവ ചേർക്കില്ല. നിങ്ങൾ യാദൃശ്ചികമായി ഏതെങ്കിലും ഫോമുകൾ ഉപേക്ഷിക്കുന്നില്ലെന്ന് ഉറപ്പാക്കുക',
